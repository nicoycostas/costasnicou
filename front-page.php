<?php get_header(); ?>
    <div class="cover-img">
        <div class="cover-img-content">
            ...
            <a href="https://resume.io/r/rQSsBhAIK" target="_blank" class="btn-cover">Download my Resume</a>
    ...
    <section id="profile">
        ...
        <div class="profile-content">
            <!-- img -->
            <img src=" <?php echo get_template_directory_uri() . '/assets/imgs/profile-pic.jpeg'; ?>" alt="" width="200" height="200">
    ...
    <section id="blog" class="blog">
        ...
        <?php if ( have_posts() ) : while ( have_posts() ) : the_post(); ?>
            <article>
                ...
                <!-- image -->
                <div class="img" style="background-size:cover; background-image: url(<?php echo the_post_thumbnail_url();?>)">
